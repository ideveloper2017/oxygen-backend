...
const foreignkey_error_filter_1 = require("./filters/foreignkey-error.filter");
async function bootstrap() {
    ...
    app.useGlobalFilters(new foreignkey_error_filter_1.ForeignKeyConstraintErrorFilter());

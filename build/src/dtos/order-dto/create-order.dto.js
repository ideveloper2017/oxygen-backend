...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: "ro'yxatdan o'tgan mijoz idisi" }),
    __metadata("design:type", Number)
], CreateOrderDto.prototype, "client_id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: "buyurtma rasmiylashtirgan xodim idisi" }),
    __metadata("design:type", Number)

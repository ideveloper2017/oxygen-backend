...
let ApartmentsService = class ApartmentsService {
    ...
    async addOneApartment(floor_id, createApartmentDto) {
        let newApartment = new apartments_entity_1.Apartments();
    ...
    async updateApartment(id, updateApartmentDto) {
